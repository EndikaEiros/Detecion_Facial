...
def gen_data(shape):
    """
    Devuelve un array con la distancia desde cada punto hasta el punto 30, que es la punta d ela nariz y nuestor centro de cara
